...
- **Tidsstyrt låsing (håndhevet i databasen):** hver kamp låses ved kampstart (norsk tid); bonus låses 11. juni 18:00. Spillere kan ikke endre etter det — admin (Henrik) kan alltid.
- **Regler-fane:** oppsummerer poeng, frister, doble runder og premiefordeling (henter live poengverdier).
- **Glemt passord:** «Glemt passord?» på innloggingssiden sender en tilbakestillingslenke på e-post (krever at e-post er aktivert i Supabase — se under).
